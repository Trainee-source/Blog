...
<%ArrayList<posts> lista = (ArrayList) request.getAttribute("listReportes");%>
<%ArrayList<posts> lista2 = (ArrayList) request.getAttribute("listaReportesBuscar");%>
...
<!-- Subscribe -->
      <div class="w3-white w3-margin">
        ...
        <div class="w3-container w3-white">
          ...
          <p>Desde: <input class="w3-input w3-border" id="txtDesde" name="txtDesde" type="date" min="2018-01-01" max="2019-12-18" style="width:30%"> 
          Hasta:<input class="w3-input w3-border" id="txtHasta" name="txtHasta" type="date"  min="2018-01-01" max="2019-12-19" style="width:30%"></p>
          <input type="submit" name="btnReportesPosts" value="Buscar" class="w3-button w3-block w3-red">
        </div>
      </div>
</div>
...
<!-- Grid -->
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        <div class="w3-center">
          <h3><a href="MostrarPostsServlet?Param=<%=i%>">Titulo :   <%= p.getPostTitulo()%></a> | Puntaje: <%= p.getPostPuntaje() %></h3>
